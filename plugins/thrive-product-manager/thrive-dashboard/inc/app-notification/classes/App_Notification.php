...
if ( ! class_exists( 'App_Notification' ) ) {
    class App_Notification {
        ...
        public function tve_dash_enqueue_notification_scripts() {
            ...
            tve_dash_enqueue_style( 'tve_dash_app_notification', TVE_DASH_URL . '/inc/app-notification/assets/css/tve-app-notification.css' );

            tve_dash_enqueue_script( 'tve_dash_app_notification', TVE_DASH_URL . '/inc/app-notification/assets/dist/tve-app-notification' . $js_prefix , array(
                'jquery',
                'backbone',
        ...
        public function add_to_dashboard_menu( $menus = array() ) {
            ...
            if( $count > 0 ) {
                $menus['app_notifications'] = array(
                    ...
                    'menu_title'  => __( 'Notifications', 'thrive-dash' ) . '<span class="notification-indicator"></span>',
